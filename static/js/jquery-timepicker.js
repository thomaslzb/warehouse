...
(function ($) {
	$.hunterTimePicker30 = function (box, options) {
		var dates = {
		...
		function buildHourTpl(){
			...
			/* hour_html += '<li class="Hunter-clean"><input type="button" class="Hunter-clean-btn" id="Hunter_clean_btn" value="Clear All"></li>' */
	...
	$.fn.extend({
		hunterTimePicker30: function (options) {
			options = $.extend({}, options);
			this.each(function () {
				new $.hunterTimePicker30(this, options);
			});
			return this;
		}
	});
	
	$.hunterTimePicker40 = function (box, options) {
		var dates = {
		  hour: ['06', '07', '08', '09', '10', '11', '12', '13', '14', '15'],
		  minute: ['00','20','40'],
		};
	...
	$.fn.extend({
		hunterTimePicker40: function (options) {
			options = $.extend({}, options);
			this.each(function () {
				new $.hunterTimePicker40(this, options);
			});
			return this;
		}
	});
