    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=8, verbose_name='Percent')),
                ('op_last_update', models.DateTimeField(auto_now=True, verbose_name='Operate Datetime')),
                ('euro_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quote.eurocountry', verbose_name='Euro Country')),
                ('uk_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quote.ukrange', verbose_name='UK Area')),
